...
* Download the file `language-server.zip` from the latest https://github.com/Sebaestschjin/typed-tabletop-simulator/releases?q=%22Lua+Language+Server+Types%22&expanded=true[release] and extract it somewhere at your local file system.
